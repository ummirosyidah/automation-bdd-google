...
public class SearchGoogle {
    ...
    public void showingResultRelatedWith(String arg0) {
        driver.findElement(By.xpath("//a[@href='https://id.linkedin.com/in/ummi-rosyidah-7bb430b6']")).isDisplayed();
        String urlLinkedinUmmi= driver.findElement(By.xpath("//a[@href='https://id.linkedin.com/in/ummi-rosyidah-7bb430b6']")).getText();
        System.out.println(urlLinkedinUmmi);
        driver.close();
        driver.quit();
    }
}
